...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2016/07/20 16:31:52 by gbuclin           #+#    #+#             */
/*   Updated: 2016/09/10 12:28:39 by lgosse           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	ft_fork2(t_vm *vm, t_process *process, t_process *new_process,
	t_list *lst)
{
...
void		ft_fork(t_vm *vm, t_process *process)
{
	...
	ft_fork2(vm, process, new_process, lst);
}
